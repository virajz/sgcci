<div x-data="{
    ...
    <flux:input wire:model.live.debounce.300ms="search" placeholder="Search by name, company, phone, or code..."
        icon="magnifying-glass" iconVariant="outline" clearable class="max-w-md" />
            ...
            <flux:table.rows>
                @foreach ($guests as $guest)
                    <flux:table.row wire:key="guest-{{ $guest->id }}">
                        ...
                        <flux:table.cell>
                            <flux:badge size="sm" color="zinc" class="font-mono">{{ $guest->registration_code }}
                            </flux:badge>
                        </flux:table.cell>
                        <flux:table.cell>
                            <flux:text class="text-sm text-zinc-500 dark:text-zinc-400">
        ...
        <div class="space-y-4">
            <div>
                ...
                <flux:text class="mt-2 text-zinc-500 dark:text-zinc-400">
                    <strong x-text="deletingGuestName"></strong> will be removed from invited guests. This cannot be
                    undone.
                </flux:text>
            </div>
