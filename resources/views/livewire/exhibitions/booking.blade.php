<div>
    <flux:main class="w-full p-4 mx-auto space-y-6 sm:p-6 lg:p-8">
        ...
        <div class="grid grid-cols-1 gap-y-6 lg:grid-cols-3 lg:gap-8">
            {{-- Map Section (Left) --}}
                        ...
                        <div class="space-y-6">
                            ...
                            @if ($isSgcciMember)
                                <div>
                                    ...
                                    <flux:radio.group wire:model="membershipType" variant="cards" class="grid gap-4">
