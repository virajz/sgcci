        ...
        <flux:card class="p-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between py-3 border-b border-zinc-200 dark:border-zinc-700">
                    <flux:text class="text-zinc-600 dark:text-zinc-400">Order ID</flux:text>
                ...
                <div class="flex items-center justify-between py-3 border-b border-zinc-200 dark:border-zinc-700">
                    <flux:text class="text-zinc-600 dark:text-zinc-400">Card Name</flux:text>
                    <flux:text class="font-semibold text-black dark:text-white">
                        {{ $responseData['card_name'] ?? 'N/A' }}
                    </flux:text>
                </div>
                ...
                @if (isset($responseData['status_message']))
                    <div class="flex items-center justify-between py-3 border-b border-zinc-200 dark:border-zinc-700">
            ...
            <div class="mt-8 space-y-3">
                ...
                @else
                    <flux:button variant="primary" href="{{ route('payment.initiate', $responseData['order_id']) }}"
                        class="w-full">
                        Try Again
                    </flux:button>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <flux:text class="text-sm text-zinc-700 dark:text-zinc-300">
                            ...
                            Order ID: <strong>{{ $responseData['order_id'] ?? 'N/A' }}</strong>
                        </flux:text>
                    </div>
                </div>
            </div>
